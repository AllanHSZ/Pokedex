...
import com.allanhsz.pokedex.adapter.PokemonAdapter;
...
public class MainActivity extends AppCompatActivity implements PokemonAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.Add).setOnClickListener(view -> startActivity(new Intent(MainActivity.this, PokemonActivity.class)));
